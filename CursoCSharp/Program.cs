    ...
    class Program {
        static void Main(string[] args) {
            var central = new CentralDeExercicios(new Dictionary<string, Action>() {
                ...
                {"Notação dos Pontos - Fundamentos", NotacaoPonto.Executar},
                {"Lendo Dados - Fundamentos", LendoDados.Executar},
                {"FormatandoNúmero - Fundamentos", FormatandoNumero.Executar},
                ...
                {"Paramâmetros Nomeados - Classes e Métodos", ParametrosNomeados.Executar},
                {"Get & Set - Classes e Métodos", GetESet.Executar},
